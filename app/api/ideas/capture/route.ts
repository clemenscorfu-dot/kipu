...
- Maximal 3 wirklich hilfreiche Tags. Bei Büchern ideal z.B. Buch, Kernthema, Autor.
- summary kurz, natürlich, erinnerungsorientiert.
- research_summary 1-2 saubere Sätze OHNE Markdown-Links, URLs oder Quellenklammern. Quellen werden separat gespeichert.
- facts nur 2-5 wirklich nützliche Fakten; keine Informationshalde.
- image_url: Wenn Web-Recherche ein eindeutiges öffentliches Haupt-/Coverbild des identifizierten Gegenstands liefert, gib eine direkte öffentlich ladbare HTTPS-Bild-URL zurück. Bei Büchern hat das offizielle Cover hohe Priorität. Wenn du keine belastbare direkte Bild-URL findest: null. Keine Suchresultatseite als image_url.
...
- location_is_subject=true nur wenn dieser Ort tatsächlich zum gespeicherten Fundstück gehört (z.B. Grillstelle hier, Restaurant in Locarno). Bei Buch/Produkt/Idee normalerweise false.
